...
# partie 5 : Putting it all together: a case study
# Python 3.X
...
50xp
In the last exercise, you showed that the mean beak length to depth ratio was 1.58 mm in 1975 and 1.47 mm in 2012. The low end of the 1975 99% confidence interval was 1.56 mm and the high end of the 99% confidence interval in 2012 was 1.49 mm. In addition to these results, what would you say about the ratio of beak length to depth?

Possible Answers
1) The mean beak length-to-depth ratio decreased by about 0.1 mm, or 7%, from 1975 to 2012. The 99% confidence intervals are not even close to overlapping, so this is a real change. The beak shape changed. 1
2) It is impossible to say if this is a real effect or just due to noise without computing a p-value. Let me compute the p-value and get back to you.
 => No, the effect size is really large. Remember, the size of the effect is most important; the p-value is in this case, just the icing on the cake.
"""
...
def draw_bs_pairs(x, y, func, size=1):
    ...
    for i in range(size):
        ...
        bs_replicates = func(bs_slope_reps,bs_intercept_reps)
