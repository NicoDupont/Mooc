...
"""
This course extends Intermediate Python for Data Science to provide a stronger foundation in data visualization in Python.
The course provides a broader coverage of the Matplotlib library and an overview of Seaborn (a package for statistical graphics).
Topics covered include customizing graphics, plotting two-dimensional arrays (e.g., pseudocolor plots, contour plots, images, etc.),
statistical graphics (e.g., visualizing distributions & regressions), and working with time series and image data.
"""
...
['seaborn-bright', 'seaborn-muted', 'seaborn-talk', 'seaborn-colorblind', 'ggplot', 'seaborn-notebook', 'seaborn-paper', 'seaborn-white', 'bmh', 'fivethirtyeight', 'seaborn-darkgrid', 'seaborn-ticks', 'seaborn-deep', 'seaborn-whitegrid', 'seaborn-poster', 'classic', 'dark_background', 'grayscale', 'seaborn-dark-palette', 'seaborn-pastel', 'seaborn-dark']
"""
